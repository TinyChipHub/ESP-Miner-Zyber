...
static const DeviceConfig default_configs[] = {
    ...
    { .board_version = "1110",  .family = FAMILY_ZYBER8G,    .EMC2101 = true, .EMC2302 = true, .TMP1075 = true, .has_three_fan=true,      .temp_offset = 10,  .TPS546 = true,            .emc_internal_temp=false,                      .power_consumption_target = 135, },
};
