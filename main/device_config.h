...
static const FamilyConfig FAMILY_ZYBER8GPLUS = { .id = ZYBER8GPLUS, .name = "Zyber8G+", .asic = ASIC_BM1370, .asic_count = 12, .max_power = 220, .power_offset = 12,  .nominal_voltage = 12,  .voltage_domains = 4, .swarm_color = "red", };
...
static const DeviceConfig default_configs[] = {
    ...
    {.board_version = "1200",  .family = FAMILY_ZYBER8GPLUS, .EMC2101 = true, .EMC2302 = true, .emc_ideality_factor = 0x32, .emc_beta_compensation = 0x00, .TMP1075 = true, .has_three_fan = true,      .temp_offset = 2,  .TPS546 = true,            .emc_internal_temp = false,                      .power_consumption_target = 200, },
};
