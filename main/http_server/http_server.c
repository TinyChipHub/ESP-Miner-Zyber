...
static esp_err_t GET_system_info(httpd_req_t * req)
{
    ...
    snprintf(GLOBAL_STATE->SYSTEM_MODULE.mac, sizeof(formattedMac), "%s", formattedMac);
    ...
    cJSON_AddNumberToObject(root, "displayAutoscroll", nvs_config_get_bool(NVS_CONFIG_DISPLAY_AUTOSCROLL));
